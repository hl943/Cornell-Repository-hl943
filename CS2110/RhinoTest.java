...
public class RhinoTest {
    ...
    public void testisOlder() {
        ...
        // R1 and R2 has same year and month
        ...
        // R8,R9, R10 year is after R1.year, R8.month is the same as R8.month, R1.isOlder is false
    ...
    public void testareSilbings() {
        ...
        Rhino Rpop2= new Rhino("Fother2", 'M', 1976, 2);
        ...
        // set Rkid8.pop to Rpop1, Rkid9.pop to Rpop2, check Rkid1 and Rkid2 are siblings, is
        // false;
        Rkid8.setPop(Rpop1);
        Rkid9.setPop(Rpop2);
